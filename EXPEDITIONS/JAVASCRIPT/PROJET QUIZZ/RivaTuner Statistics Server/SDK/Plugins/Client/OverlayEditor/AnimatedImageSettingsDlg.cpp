...
void CAnimatedImageSettingsDlg::OnBnClickedOk()
{
	...
	if (iSelection != -1)
	{
		...
		m_strText = extension.FormatAnimatedImageTag(m_nImageTemplate ? TRUE : FALSE, m_strSource, m_nImageWidth, m_nImageHeight, m_fltImageMin, m_fltImageMax, m_nSpriteX, m_nSpriteY, m_nSpriteWidth, m_nSpriteHeight, m_nSpritesNum, m_nSpritesPerLine, m_fltImageBias);
	}
