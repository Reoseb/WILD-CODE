// HALImplementationATIADL.h: interface for the CHALImplementationATIADL class.
//
// created by Unwinder
//////////////////////////////////////////////////////////////////////
#pragma once
...
//////////////////////////////////////////////////////////////////////
class CHALImplementationATIADL : public CHALImplementation
{
public:
	CHALImplementationATIADL();
	virtual ~CHALImplementationATIADL();

	void SetATIADLWrapper(CATIADLWrapper* lpATIADLWrapper);
...
protected:
	CATIADLWrapper*	m_lpATIADLWrapper;
	DWORD			m_dwGpu;
};
//////////////////////////////////////////////////////////////////////
