	...
	if (iSelection != -1)
	{
		...
		else
		{
			...
			if (m_bAddImage)
			{
				...
				{
				case 0:
					m_strText += extension.FormatAnimatedImageTag(FALSE, strSource, m_nImageWidth, m_nImageHeight, m_fltImageMin, m_fltImageMax, m_nImageSpriteX, m_nImageSpriteY, m_nImageSpriteWidth, m_nImageSpriteHeight, m_nImageSpritesNum, m_nImageSpritesPerLine, m_fltImageBias);
					break;
				case 1:
					m_strText += extension.FormatAnimatedImageTag(TRUE, strSource, m_nImageWidth, m_nImageHeight, m_fltImageMin, m_fltImageMax, m_nImageSpriteX, m_nImageSpriteY, m_nImageSpriteWidth, m_nImageSpriteHeight, m_nImageSpritesNum, m_nImageSpritesPerLine, m_fltImageBias);
					break;
				case 2:
					m_strText += extension.FormatImageTag(m_nImageWidth, m_nImageHeight, m_nImageSpriteX, m_nImageSpriteY, m_nImageSpriteWidth, m_nImageSpriteHeight);
					break;
				}
			}
		}
