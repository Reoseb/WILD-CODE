...
private:
	...
	BOOL IsIntValue(LPFORMULATRANSLATOR_VALUE_DESC pDesc);
	BOOL IsFltValue(LPFORMULATRANSLATOR_VALUE_DESC pDesc);
		//operand type verification helpers

	LONG  GetIntValue(LPFORMULATRANSLATOR_VALUE_DESC pDesc);
	FLOAT GetFltValue(LPFORMULATRANSLATOR_VALUE_DESC pDesc);
