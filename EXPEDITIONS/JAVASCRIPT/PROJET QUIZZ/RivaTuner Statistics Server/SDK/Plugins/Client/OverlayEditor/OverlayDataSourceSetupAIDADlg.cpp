// OverlayDataSourceSetupAIDADlg.cpp : implementation file
//
// created by Unwinder
/////////////////////////////////////////////////////////////////////////////
#include "stdafx.h"
...
/////////////////////////////////////////////////////////////////////////////
IMPLEMENT_DYNAMIC(COverlayDataSourceSetupAIDADlg, CDialog)
/////////////////////////////////////////////////////////////////////////////
COverlayDataSourceSetupAIDADlg::COverlayDataSourceSetupAIDADlg(CWnd* pParent /*=NULL*/)
	: CDialog(COverlayDataSourceSetupAIDADlg::IDD, pParent)
{
	m_lpSource			= NULL;
	m_hBrush			= NULL;
...
/////////////////////////////////////////////////////////////////////////////
COverlayDataSourceSetupAIDADlg::~COverlayDataSourceSetupAIDADlg()
{
}
/////////////////////////////////////////////////////////////////////////////
void COverlayDataSourceSetupAIDADlg::DoDataExchange(CDataExchange* pDX)
{
...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(COverlayDataSourceSetupAIDADlg, CDialog)
	ON_WM_DESTROY()
	ON_WM_CTLCOLOR()
	ON_EN_CHANGE(IDC_SOURCE_FORMAT_EDIT, &COverlayDataSourceSetupAIDADlg::OnEnChangeSourceFormatEdit)
	ON_EN_CHANGE(IDC_FORMULA_EDIT, &COverlayDataSourceSetupAIDADlg::OnEnChangeFormulaEdit)
	ON_BN_CLICKED(IDOK, &COverlayDataSourceSetupAIDADlg::OnBnClickedOk)
END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////
// COverlayDataSourceSetupAIDADlg message handlers
/////////////////////////////////////////////////////////////////////////////
void COverlayDataSourceSetupAIDADlg::SetSource(COverlayDataSourceAIDA* lpSource)
{
	m_lpSource = lpSource;
...
/////////////////////////////////////////////////////////////////////////////
BOOL COverlayDataSourceSetupAIDADlg::ValidateSource()
{
	m_strSensorID.Trim();
...
/////////////////////////////////////////////////////////////////////////////
BOOL COverlayDataSourceSetupAIDADlg::OnInitDialog()
{
...
/////////////////////////////////////////////////////////////////////////////
void COverlayDataSourceSetupAIDADlg::OnDestroy()
{
	if (m_hBrush)
	{
...
/////////////////////////////////////////////////////////////////////////////
HBRUSH COverlayDataSourceSetupAIDADlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
/////////////////////////////////////////////////////////////////////////////
void COverlayDataSourceSetupAIDADlg::OnEnChangeSourceFormatEdit()
{
	UpdateData(TRUE);
...
/////////////////////////////////////////////////////////////////////////////
void COverlayDataSourceSetupAIDADlg::OnEnChangeFormulaEdit()
{
	UpdateData(TRUE);
...
/////////////////////////////////////////////////////////////////////////////
void COverlayDataSourceSetupAIDADlg::OnBnClickedOk()
{
	UpdateData(TRUE);
